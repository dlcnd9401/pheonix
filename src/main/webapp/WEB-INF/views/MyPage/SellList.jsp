   ...
   $(document).ready(function(){
      ...
      function createPaging(){
        ...
        function initData(){ // 디비에서 데이터 가져오기 위한 함수
         ...
         //삭제버튼
          $(".Sellbagdel").off().on("click", function(){
...
<div id="Sellmymain">
 <div class="Selltitlebox">  
   ...
   <div class="Sellbuydelbtns"> 
          <a href="model"><button type="button" class="Cartbtn1 Cartbagbuy">Home</button></a>
          <button type="button" class="Cartbtn1 Sellbagdel">삭제</button>
